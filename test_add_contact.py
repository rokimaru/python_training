...
class TestAddContact(unittest.TestCase):
    ...
    def fill_contact_form(self, wd):
        ...
        wd.find_element_by_name("lastname").send_keys("test_surname")
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys("test_nickname")
        ...
        wd.find_element_by_name("address").send_keys("test_adress")
        ...
        wd.find_element_by_name("home").send_keys("79111111111")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("79111111111")
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("79111111111")
        wd.find_element_by_name("fax").click()
        wd.find_element_by_name("fax").clear()
        wd.find_element_by_name("fax").send_keys("79111111111")
